...
- Helm template rendering and Kubernetes schema validation, for both `values-aws.yaml` and `values-local.yaml` on every `gitops/` component (spec 021 Requirement 17).
- YAML linting.
