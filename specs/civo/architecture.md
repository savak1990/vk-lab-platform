...
| Capacity | `modules/karpenter-pod-identity`, `gitops/.../karpenter/*` | Karpenter, EC2NodeClass, spot label | provider | Medium pool created at two nodes; cluster autoscaler holds it between 2 and 3 | new units; values toggles for spot affinity | 030, 050, 170 |
