...
| CIVO-130 | [130-D-e2e-tests-civo](130-D-e2e-tests-civo/spec.md) | E2E suite on Civo | DONE | P1 | M | standard | 045, 060 | M1 |
...
| CIVO-170 | [170-A-civo-cluster-autoscaler](170-A-civo-cluster-autoscaler/spec.md) | Cluster autoscaler 2–3 on the Medium pool | IN_PROGRESS | P2 | S | standard | 030 | M2 |
| CIVO-172 | [172-A-argo-stuck-operation-resilience](172-A-argo-stuck-operation-resilience/spec.md) | Argo operations that never end, and the teardown they deadlock | IN_PROGRESS | P1 | S | standard | 170 | M2 |
