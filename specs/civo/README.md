...
| CIVO-180 | [180-cnpg-backups-object-store](180-cnpg-backups-object-store/spec.md) | Backup bucket, presigned-URL signing, and the server image pin | READY | P1 | S | standard | 040, 115 | M1 |
