...
| CIVO-120 | [120-cnpg-on-civo-persistence](120-cnpg-on-civo-persistence/spec.md) | CloudNativePG on Civo with data surviving make down and make up | READY | P1 | L | strongest | 050, 100, 115, 180 | M1 |
...
| CIVO-180 | [180-cnpg-backups-object-store](180-cnpg-backups-object-store/spec.md) | Backup bucket, S3 identity on both providers, and the pg-backup image | READY | P1 | M | standard | 082, 085, 100 | M1 |
