...
4. The public traffic path (architecture.md §8, §11) MUST keep working without regression — ALB and any public-facing resource must remain reachable via public subnets in the new VPC.
