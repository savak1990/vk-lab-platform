...
| HETZ-016 | [016-A-non-aws-generalisation](016-A-non-aws-generalisation/spec.md) | `= civo` script branches and `eq "civo"` gates become non-AWS; Civo behaviour unchanged | IN_PROGRESS | P0 | M | strongest | 010 | M0 |
