...
| HETZ-040 | [040-A-hetzner-cluster-scripts](040-A-hetzner-cluster-scripts/spec.md) | Cluster scripts: `hcloud` helpers, SSH kubeconfig, node-Ready wait, `cluster_exists`, `node-ssh`, label-based leak sweep | IN_REVIEW | P1 | M | standard | 017, 030 | M1 |
...
| HETZ-177 | [177-P-hetzner-arm-node-types](177-P-hetzner-arm-node-types/spec.md) | ARM node types (CAX) in the Hetzner catalogue, verified end to end | DRAFT | P1 | M | standard | 040, 045, 182 | M2 |
