...
| HETZ-045 | [045-A-argo-scripts-hetzner-branches](045-A-argo-scripts-hetzner-branches/spec.md) | `argo-up` Hetzner branch: `hcloud` Secret, CCM helm install, taint wait, root Application, LB/DNS waits | IN_REVIEW | P1 | M | strongest | 016, 040, 050 | M1 |
