...
| HETZ-080 | [080-A-ca-ceremony-and-rolesanywhere-hetzner](080-A-ca-ceremony-and-rolesanywhere-hetzner/spec.md) | CA ceremony and `bootstrap/rolesanywhere` for the Hetzner project, before its first `bootstrap-up` | IN_PROGRESS | P0 | S | strongest | 018, CIVO-080, CIVO-082 | M1 |
