...
| HETZ-030 | [030-A-hetzner-terraform-k3s-nodes](030-A-hetzner-terraform-k3s-nodes/spec.md) | `cluster-hetzner` firewall and `NODE_COUNT` `cx33` servers that install k3s from their own cloud-init | IN_REVIEW | P1 | M | strongest | 010, 015, 017, 025 | M1 |
