...
|---|---|---|---|---|---|---|---|---|
| HETZ-010 | [010-A-provider-command-surface](010-A-provider-command-surface/spec.md) | `PROVIDER=hetzner` operator input, defaults, token helper | IN_REVIEW | P1 | S | standard | — | M0 |
