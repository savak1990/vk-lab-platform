...
|---|---|---|---|---|---|---|---|---|
| HETZ-010 | [010-A-provider-command-surface](010-A-provider-command-surface/spec.md) | `PROVIDER=hetzner` operator input, defaults, token helper | IN_PROGRESS | P1 | S | standard | — | M0 |
