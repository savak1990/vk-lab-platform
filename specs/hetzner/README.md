...
| HETZ-050 | [050-A-gitops-hetzner-target-baseline](050-A-gitops-hetzner-target-baseline/spec.md) | `target: hetzner` tree: CSI Application, storage class, render check, golden diffs | IN_REVIEW | P1 | M | standard | 016, CIVO-050 | M1 |
