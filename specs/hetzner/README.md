...
| HETZ-037 | [037-P-hetzner-cilium-cni](037-P-hetzner-cilium-cni/spec.md) | Cilium from the control plane's cloud-init; `cluster-up` ends when every node is Ready | READY | P1 | M | standard | 035 | M1 |
