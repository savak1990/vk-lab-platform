...
**Status note:** Implemented — Req 2/5 (Terraform-owned volume + static-PV rebind) superseded by ADR 0013 (CNPG VolumeSnapshot recovery, see spec 007-1)
