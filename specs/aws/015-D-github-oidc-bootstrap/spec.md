...
**Status note:** Implemented — the unit lives in the account layer, not the Bootstrap stack, and omits `thumbprint_list` (ADR 0021 supersedes the original implementation hints).
