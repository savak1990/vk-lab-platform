...
**Depends on:** 002-persistent-foundation (this spec extends the persistent Terraform stack), 003-network-and-eks (the default-VPC EKS setup being replaced), and implicitly 005-storage-contract/007-postgres/025-kafka (retained data whose AZ placement constrains the new VPC's design)
