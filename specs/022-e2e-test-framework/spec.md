...
**Estimated cost:** ~1.5–2 days · AWS runtime cost: none — this spec is pure Go tooling, reused by (not run standalone in) specs 019 and 023.
**Recommended model:** Sonnet — well-documented Go/Ginkgo patterns, low architectural ambiguity.
**Depends on:** none directly; consumed by 019-ci-full-lifecycle-validation and 023-ci-kind-integration-test.
