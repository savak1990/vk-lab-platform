...
# directory, which then makes `terraform destroy` refuse to proceed
# ("Backend configuration has changed"). Clear it unconditionally so this
# always starts from a clean init.
