...
labels "ci:lifecycle selects every cloud that has a job" "$BOTH_CLOUDS" '["ci:lifecycle"]'
labels "ci:lifecycle plus a narrower label is still both" "$BOTH_CLOUDS" '["ci:lifecycle","ci:lifecycle-aws"]'
